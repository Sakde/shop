						...
						<table>
							<tbody><tr>
								...
								<td>
									...
									<span id="span1"><f:errors path="username"/></span>
								</td>
							</tr>
							<tr>
								<th>
								...
								<td>
									...
									<span><f:errors path="password"/></span>
								</td>
							</tr>
							<tr>
								<th>
...
<div class="ad">
	...
	<dd>
		自由退换、售后上门
								...
								<dd>
									立即登录即可体验在线购物！
									<a href="${pageContext.request.contextPath}/user_loginPage">立即登录</a>
								</dd>
							</dl>
						</div>
					</form>
